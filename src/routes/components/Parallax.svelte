...
>
  <svg
    ...
    style="transform: translate3d(-37.26px, 17.64px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: relative; display: block;"
    ><path
  ...
  <svg
    ...
    class="layer p2"
    xmlns="http://www.w3.org/2000/svg"
    style="transform: translate3d(-24.84px, 11.76px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block;"
    ><path
  ...
  <svg
    ...
    class="layer p3"
    xmlns="http://www.w3.org/2000/svg"
    style="transform: translate3d(-37.26px, 17.64px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block;"
    ><path
  ...
  <svg
    ...
    class="layer p4"
    xmlns="http://www.w3.org/2000/svg"
    style="transform: translate3d(-74.52px, 35.28px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block;"
    ><rect
  ...
  <svg
    ...
    class="layer p6"
    xmlns="http://www.w3.org/2000/svg"
    style="transform: translate3d(-62.1px, 29.4px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block;"
  ...
  <svg
    ...
    class="layer p7"
    xmlns="http://www.w3.org/2000/svg"
    style="transform: translate3d(-49.68px, 23.52px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block;"
    ><path
